        ...
        <div class="inside-container top-bar">
          <div class="row">
            <div class="col-md-4 top-bar-left order-2 order-md-12">
              ...
              <a href="mailto:info@webdomus.net">info@rakshith.com</a>
            </div>    
          ...
          <div class="row yogaPlace-col">
            <div class="col-lg-3">
              <div class="yogaPlace-img">
                <img src="../assets/kundalini-yoga.jpg" class="yogaPlace-in-img" alt="">
              </div>              
            ...
            <div class="col-lg-3">
              <div class="yogaPlace-img">
                <img src="../assets/basic-yoga.jpg" class="yogaPlace-in-img" alt="">
              </div>
            ...
            <div class="col-lg-3">
              <div class="yogaPlace-img">
                <img src="../assets/iyengar-yoga.jpg" class="yogaPlace-in-img" alt="">
              </div>
            ...
            <div class="col-lg-3">
              <div class="yogaPlace-img">
                <img src="../assets/advanced-yoga-poses.jpg" class="yogaPlace-in-img" alt="">
              </div>
          ...
          <div class="row trainer-col">
            <div class="col-lg-3">
              <div class="trainer-img">
                <img src="../assets/fig-nelson.jpg" class="trainer-in-img" alt="">
              </div>              
            ...
            <div class="col-lg-3">
              <div class="trainer-img">
                <img src="../assets/jason-response.jpg" class="trainer-in-img" alt="">
              </div>
            ...
            <div class="col-lg-3">
              <div class="trainer-img">
                <img src="../assets/eric-widget.jpg" class="trainer-in-img" alt="">
              </div>
            ...
            <div class="col-lg-3">
              <div class="trainer-img">
                <img src="../assets/lance-begrol.jpg" class="trainer-in-img" alt="">
              </div>
